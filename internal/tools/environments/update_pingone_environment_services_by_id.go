...
VERY IMPORTANT: Before updating, first get the latest list of services using the 'get_environment_services_by_id' tool to avoid overwriting pre-existing configuration values.`,
