...
func TestGetEnvironmentHandler_MockClient(t *testing.T) {
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			handler := environments.GetEnvironmentHandler(envtestutils.NewMockEnvironmentsClientFactory(mockClient, nil), testutils.MockContextInitializer())
...
func TestGetEnvironmentHandler_GetAuthenticatedClientError(t *testing.T) {
	...
	handler := environments.GetEnvironmentHandler(envtestutils.NewMockEnvironmentsClientFactory(mockClient, clientFactoryErr), testutils.MockContextInitializer())
	req := &mcp.CallToolRequest{}
	input := environments.GetEnvironmentInput{
		EnvironmentId: testEnv1.id,
	}
...
func TestGetEnvironmentHandler_InitializeAuthContextError(t *testing.T) {
	mockClient := &envtestutils.MockEnvironmentsClient{}
	initContextErr := errors.New("failed to initialize auth context")
	handler := environments.GetEnvironmentHandler(envtestutils.NewMockEnvironmentsClientFactory(mockClient, nil), testutils.MockContextInitializerWithError(initContextErr))
	req := &mcp.CallToolRequest{}
	input := environments.GetEnvironmentInput{
		EnvironmentId: testEnv1.id,
	}
...
func TestGetEnvironmentHandler_InitializeAuthContext(t *testing.T) {
	testCases := []struct {
		name                       string
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			mockClient := &envtestutils.MockEnvironmentsClient{}
			expectedEnv := createEnvironmentResponse(t, testEnv1)
			mockGetEnvironmentSetup(mockClient, testEnv1.id, &expectedEnv, 200, nil)
			...
			handler := environments.GetEnvironmentHandler(envtestutils.NewMockEnvironmentsClientFactory(mockClient, nil), authContextInitializer)
			req := &mcp.CallToolRequest{}
			input := environments.GetEnvironmentInput{
				EnvironmentId: testEnv1.id,
			}
...
func TestGetEnvironmentHandler_RealClient(t *testing.T) {
	...
	handler := environments.GetEnvironmentHandler(envtestutils.NewMockEnvironmentsClientFactory(clientWrapper, nil), testutils.MockContextInitializer())
